...
Below are featured courses. Click any card title or the **Visit Course** button to open the course website.
  ...
  <div class="course-card">
    <div class="course-card-body">
      <h2 class="course-title">
        <a href="https://go.ncsu.edu/mycoed" target="_blank" rel="noopener">
          BSC 495: The Hidden World's Code (MycoEd)
        </a>
      </h2>
    ...
    <div class="course-logo">
      <a href="https://go.ncsu.edu/mycoed" target="_blank" rel="noopener" aria-label="Open MycoEd course website">
        <img src="assets/courses/mycoed.png" alt="BSC 495: The Hidden World's Code (MycoEd)" loading="lazy">
      </a>
    </div>
  </div>
